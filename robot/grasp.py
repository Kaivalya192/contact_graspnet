...
grasp_predictions_in_camera_frame = grasp_predictions_in_camera_frame.item()[1] # dict as np array, need to get object first and then select dict key for segmask
